...
def healpix_weightmatrix(nside=16, nest=True, indexes=None, dtype=np.float32, new_weighting=False):
...
def build_laplacians(nsides, indexes=None, use_4=False, new_weighting=False):
