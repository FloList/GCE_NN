...
def get_params_CNN_pre_gen(HPC):
    ...
    CONST_EXP = True  # is the exposure for the maps taken to be constant (Fermi mean exposure)?
    MODELS = ["iso", "iso_PS"]  # Templates
    MODEL_NAMES = ["P", "NP"]  # Template names
    ...
    params["gce_hist_templates"] = []  # ["gce_12_PS", "thin_disk_PS"]  # list of PS templates with histogram
    ...
    for temp in MODELS:
        ...
        # 2) Non-Poissonian templates: for now: means
        else:
            # Mean
    ...
    #params['M'] = [128, 64, params["n_params"]]
