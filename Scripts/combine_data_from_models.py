...
Moreover, masks can be applied and the ROI can be reduced.
...
input_path = '/scratch/u95/fl9575/GCE_v2/data/GCE_maps' if HPC else '/home/flo/PycharmProjects/GCE/data/GCE_maps'
name = "GCE_and_background"  # folder name for combined data
filename_out = "GCE_maps"  # filename basis for combined maps
...
extend_to_length = 10  # if not None: reuse files in order to generate "extend_to_length" random combinations of
                       # the maps from the individual models (only for training data)
N_test = 2  # number of samples for the test set (have NO contribution in common with training set)
