...
def get_params(int_flag=0):
    ...
    ###################################
    p_tt = DotDict()
    p_tt["data_name"] = "Comparison_1_christophers_data"  # name of data folder for the template maps
    ...
    p_tt["n_chunk"] = int(5050)  # number of chunks to compute per job
    ...
    prior_dict["dif_silvia"] = np.asarray([2.5e5, 5e5])  # note that Christopher's template has a different normalization!
    ...
    ###################################
    p_comb = DotDict()
    p_comb["data_name"] = "Comparison_1_christophers_data_comb"  # name of data folder for the combined maps
