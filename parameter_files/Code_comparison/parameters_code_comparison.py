...
def get_params(int_flag=0):
    ...
    p_data["exposure"] = "../../../Comparison_project/Data/Numpy/fermi_data_256/exp_10_bins.npy"  # one of "Fermi", "Fermi_mean", constant float, or filename of a custom exposure map
