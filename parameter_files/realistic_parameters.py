...
def get_params(int_flag=0):
    ...
    p_mod["model_names_PS"] = ["GCE", "disk PS"]  # names: PS
    p["mod"] = p_mod

    # Template map settings (for training and testing maps)
    ###################################
    p_tt = DotDict()
    p_tt["data_name"] = "Realistic"  # name of data folder for the template maps
    ...
    ###################################
    p_comb = DotDict()
    p_comb["data_name"] = "Realistic_comb"  # name of data folder for the combined maps
    ...
    # "softmax" or "normalized_softplus"
    p_hist["calculate_residual"] = False  # TODO True! calculate FF residual and feed as an additional input to the brightness part
    ...
    ###################################
    p_plot = DotDict()
    p_plot["colors_P"] = ['#ff0000', '#ec7014', '#fec400', '#37c837']  # plot colors for the Poissonian models
